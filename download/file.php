...
function send_file_to_browser($attachment, $upload_dir, $category)
{
    ...
    //$ext = isset($filename_parts['extension']) ? '.' . strtolower($filename_parts['extension']) : '';
    //$filename_resized = $filename_parts['dirname'] . '/resized/' . $filename_parts['filename'] . $ext;

    //if ($category == ATTACHMENT_CATEGORY_IMAGE)
    //{
    //    if (!@file_exists($filename_resized))
    //    {
    //        require($phpbb_root_path . 'includes/SimpleImage.php');
    ...
    //        }
    //        $image->save($filename_resized);
    //    }

    //    if(@file_exists($filename_resized)) $filename = $filename_resized;
    //}
