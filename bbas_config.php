<?php
// Russian Advanced Textual Confirmation settings
// Contributed by: Oleg Parashchenko, http://uucode.com/blog/
...
//
$questions = array(
  'Какого года ваша машина? (4 цифры)'      => array ('1997', '1998', '1999', '2000', '2001', '2002'),
...
$lang = array (
  ...
  'TITLE'    => 'Продвинутое Текстовое Подтверждение',
  'EXPLAIN'  => 'Ответьте на вопрос, чтобы показать, что вы не спамбот, а человек.',
  'SUBMIT'   => 'Отправить ответ',
  'FOOTNOTE' => 'Этот сайт защищён от спама. Спасибо <a href="http://bbantispam.com/atc/" target="_blank">Advanced Textual Confirmation</a> от <a href="http://bbantispam.com/" target="_blank">bbAntiSpam</a>.'
);
