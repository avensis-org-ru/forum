...
$lang = array_merge($lang, array(
	...
	// -----------------------------------------
	'acl_m_cpgadmin'		=> array('lang' => 'Can manage coppermine gallery<br /><em>This setting is only assigned globally. It is not forum based.</em>', 'cat' => 'misc'),
	// -----------------------------------------
));
...
$lang = array_merge($lang, array(
	...
	// Berechtigung Admin Coppermine ergänzt
	// -----------------------------------------
	'acl_a_cpgadmin'		=> array('lang' => 'Can manage coppermine gallery', 'cat' => 'misc'),
	// -----------------------------------------
));
