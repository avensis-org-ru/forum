...
$cpg_db_name = 'avensis';	// Gallery database name
$cpg_db_user = 'root';		// Gallery database user
$cpg_db_pass = '9ezc6iUdxD';		// Gallery database password
$cpg_table_prefix = 'cpg14x_';	// Gallery table prefix
...
{
	$cpg_ug = $user->lang['CPG_no_ug'];
}
else
{
	$cpg_ug = '<a href="' . $cpg_path . 'index.php?cat=' . $cpg_cat_id . '">' . $user->lang['CPG_goto_ug'] . '</a>';
}

$template->assign_vars(array(
	'L_CPG_UG' => $user->lang['CPG_ug'],
	'CPG_UG' => $cpg_ug)
);
...
//$cpg_db_host = 'localhost';	// Gallery database host
//$cpg_db_name = 'avensis';	// Gallery database name
//$cpg_db_user = 'avensis';		// Gallery database user
//$cpg_db_pass = '0o9i8u';		// Gallery database password
//$cpg_table_prefix = 'cpg14x_';	// Gallery table prefix
//$cpg_path = '../gallery/';	// Gallety path, absolute or relative to phpBB root dir
///* End of configuration section */
//
